...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_GRAVE_CHOKE" = TRAIT_GRAVE_CHOKE,

		"TRAIT_BIG_LEAGUES" = TRAIT_BIG_LEAGUES,
		"TRAIT_BUFFOUT_BUFF" = TRAIT_BUFFOUT_BUFF,
		"TRAIT_IRONFIST" = TRAIT_IRONFIST,

		"TRAIT_CHEMWHIZ" = TRAIT_CHEMWHIZ,
		"TRAIT_TECHNOPHOBE" = TRAIT_TECHNOPHOBE,
		"TRAIT_LONGPORKLOVER" = TRAIT_LONGPORKLOVER,
		"TRAIT_TRIBAL" = TRAIT_TRIBAL,
		"TRAIT_BERSERKER" = TRAIT_BERSERKER,
		"TRAIT_TECHNOPHREAK" = TRAIT_TECHNOPHREAK,
		"TRAIT_MEDICALEXPERT" = TRAIT_MEDICALEXPERT,
		"TRAIT_MEDICALGRADUATE" = TRAIT_MEDICALGRADUATE,
		"TRAIT_UNETHICAL_PRACTITIONER" = TRAIT_UNETHICAL_PRACTITIONER,
		"TRAIT_CYBERNETICIST" = TRAIT_CYBERNETICIST,
		"TRAIT_CYBERNETICIST_EXPERT" = TRAIT_CYBERNETICIST_EXPERT,
		"TRAIT_MACHINE_SPIRITS" = TRAIT_MACHINE_SPIRITS,
		"TRAIT_HARD_YARDS" = TRAIT_HARD_YARDS,
		"TRAIT_MARS_TEACH" = TRAIT_MARS_TEACH,
		"TRAIT_TRAPPER" = TRAIT_TRAPPER,
		"TRAIT_SURGERY_LOW" = TRAIT_SURGERY_LOW,
		"TRAIT_SURGERY_MID" = TRAIT_SURGERY_MID,
		"TRAIT_SURGERY_HIGH" = TRAIT_SURGERY_HIGH,
		"TRAIT_GUNSMITH_ONE" = TRAIT_GUNSMITH_ONE,
		"TRAIT_GUNSMITH_TWO" = TRAIT_GUNSMITH_TWO,
		"TRAIT_GUNSMITH_THREE" = TRAIT_GUNSMITH_THREE,
		"TRAIT_GUNSMITH_FOUR" = TRAIT_GUNSMITH_FOUR,
		"TRAIT_BOOK_TRAIT" = BOOK_TRAIT,
