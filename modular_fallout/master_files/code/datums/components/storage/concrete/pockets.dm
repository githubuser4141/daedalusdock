...
/datum/storage/concrete/pockets/small/collar/New()
	set_holdable(list(
...
/datum/storage/concrete/pockets/treasurer/New()
	set_holdable(list(
...
/datum/storage/concrete/pockets/bartender/New()
	set_holdable(list(
	/obj/item/kitchen,
...
/datum/storage/concrete/pockets/kitchen/New()
	set_holdable(list(
	/obj/item/kitchen,
...
/datum/storage/concrete/pockets/crafter/New()
	set_holdable(list(
	/obj/item/crowbar,
	/obj/item/wrench,
...
/datum/storage/concrete/pockets/medical/New()
	set_holdable(list(
...
/datum/storage/concrete/pockets/shoes/New()
	set_holdable(list(
	/obj/item/reagent_containers/syringe,
...
/datum/storage/concrete/pockets/small/rushelmet/New()
//	set_holdable(list(
...
/datum/storage/concrete/pockets/bos/paladin/New()
	set_holdable(list(
...
/datum/storage/concrete/pockets/small/holdout/New()
	set_holdable(list(
...
/datum/storage/concrete/pockets/bulletbelt/New()
	set_holdable(list(
	/obj/item/ammo_box/magazine,
	/obj/item/ammo_box/tube,
	/obj/item/ammo_box/a357,
