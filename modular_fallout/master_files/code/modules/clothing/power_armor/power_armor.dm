...
/obj/item/clothing/suit/space/hardsuit/ms13/power_armor/proc/GetInside(mob/living/carbon/human/user)
	...
	user.dna.species.no_equip_flags += ITEM_SLOT_BACK
	user.dna.species.no_equip_flags += ITEM_SLOT_BELT
...
TYPEINFO_DEF(/obj/item/clothing/head/helmet/space/hardsuit/ms13/power_armor/t51)
	default_armor = list(
	BLUNT = CLASS7_BLUNT,
...
TYPEINFO_DEF(/obj/item/clothing/head/helmet/space/hardsuit/ms13/power_armor/t45)
	default_armor = list(
	BLUNT = CLASS7_BLUNT,
...
TYPEINFO_DEF(/obj/item/clothing/head/helmet/space/hardsuit/ms13/power_armor/advanced)
	default_armor = list(
	BLUNT = CLASS8_BLUNT,
