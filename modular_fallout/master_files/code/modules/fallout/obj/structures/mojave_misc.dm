...
/obj/structure/ms13/storage/Initialize()
...
/obj/structure/ms13/storage/washingmachine/Initialize(mapload)
	. = ..()
	create_storage(storage_type = /datum/storage/artificial/medium)
	register_context()
...
/obj/structure/ms13/storage/washingmachine/Initialize(mapload)
	. = ..()
	create_storage(storage_type = /datum/storage/artificial/large)
	if(working)
