...
/obj/structure/wreck/car
	...
	icon = 'modular_fallout/master_files/icons/fallout/vehicles/medium_vehicles.dmi'
	icon_state = "derelict"
	bound_width = 64
...
/obj/structure/wreck/bus
	...
	bound_width = 192
	bound_height = 64
	icon = 'modular_fallout/master_files/icons/fallout/vehicles/bus1.dmi'

/obj/structure/wreck/bus/blue
	icon_state = "blue"

/obj/structure/wreck/bus/blue/alt
	icon = 'modular_fallout/master_files/icons/fallout/vehicles/bus2.dmi'
	bound_width = 192
	bound_height = 64
...
/obj/structure/wreck/bus/rusted
	name = "wrecked bus"
	desc = "An old pre-war vehicle, rusted and destroyed with age and weathering."
	icon = 'modular_fallout/master_files/icons/fallout/vehicles/rustybus.dmi'
	icon_state = "bus"
	bound_width = 192
	bound_height = 64
...
/obj/structure/wreck/bus/rusted/segmented
	name = "wrecked bus"
	desc = "An old pre-war vehicle, rusted and destroyed with age and weathering."
	icon = 'modular_fallout/master_files/icons/fallout/vehicles/rustybussegmented.dmi'
	icon_state = "bus1"
	bound_width = 32
	bound_height = 32
