...
GLOBAL_LIST_INIT(scrap_wood_recipes, list ( \
	...
	new/datum/stack_recipe("drying rack", /obj/machinery/smartfridge/drying_rack, 8, time = 15 SECONDS, one_per_turf = TRUE, on_floor = TRUE), \
	new/datum/stack_recipe("fermentation barrel", /obj/structure/fermenting_barrel, 8, time = 15 SECONDS, one_per_turf = TRUE, on_floor = TRUE), \
))
...
GLOBAL_LIST_INIT(plank_recipes, list ( \
	...
	new/datum/stack_recipe("drying rack", /obj/machinery/smartfridge/drying_rack, 4, time = 15 SECONDS, one_per_turf = TRUE, on_floor = TRUE), \
	new/datum/stack_recipe("fermentation barrel", /obj/structure/fermenting_barrel, 4, time = 15 SECONDS, one_per_turf = TRUE, on_floor = TRUE), \
...
GLOBAL_LIST_INIT(ms13cloth_recipes, list ( \
	new/datum/stack_recipe("roll of gauze", /obj/item/stack/gauze, 2, time = 3 SECONDS, one_per_turf = FALSE, on_floor = FALSE), \
))
...
GLOBAL_LIST_INIT(scrap_recipes, list ( \
	...
	new/datum/stack_recipe("makeshift smelter", /obj/machinery/mineral/ore_redemption, 6, time = 30 SECONDS, one_per_turf = TRUE, on_floor = TRUE), \
...
GLOBAL_LIST_INIT(scrap_steel_recipes, list ( \
	...
	new/datum/stack_recipe("makeshift smelter", /obj/machinery/mineral/ore_redemption, 4, time = 30 SECONDS, one_per_turf = TRUE, on_floor = TRUE), \
