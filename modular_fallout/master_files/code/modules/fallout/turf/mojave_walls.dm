...
/turf/closed/wall/ms13/break_wall(drop_mats = TRUE)
	if(drop_mats)
		drop_materials_used()
	return new girder_type(src, reinf_material, wall_paint, stripe_paint)
/*
/turf/closed/wall/ms13/drop_materials_used(drop_reinf = FALSE)
	.=..()
	new plating_mat_ref.sheet_type(src, sheet_amount)
	if(drop_reinf && reinf_material)
		new reinf_mat_ref.sheet_type(src, sheet_amount)
*/
...
/turf/closed/wall/ms13/craftable/scrap
	...
	girder_type = null
	plating_material = /obj/item/stack/sheet/ms13/scrap
	sheet_amount = 6
...
/turf/closed/wall/ms13/craftable/wood
	...
	frill_icon = 'mojave/icons/turf/walls/woodfresh_frill.dmi'
	girder_type = null
	plating_material = /obj/item/stack/sheet/ms13/wood/log
	sheet_amount = 2
	slicing_duration = 30 SECONDS
