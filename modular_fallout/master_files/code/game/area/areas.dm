...
//	poweralm = FALSE
	...
	ambientsounds = list('modular_fallout/master_files/sound/f13ambience/wasteland.ogg', 'modular_fallout/master_files/sound/f13ambience/sewer.ogg')
...
/area/f13/underground/enclave_base
	...
	ambientsounds = list('modular_fallout/master_files/sound/f13ambience/enclave_vault.ogg')
...
/area/f13/underground/overseer_office
	...
	requires_power = TRUE
	ambientsounds = list('modular_fallout/master_files/sound/f13ambience/vaulttec_vault.ogg')
